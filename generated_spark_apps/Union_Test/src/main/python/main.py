"""
Main Application for Union_Test
...
def setup_logging(log_level: str = "INFO"):
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('logs/union_test.log')
        ]
    )
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Union_Test Spark Application')
    ...
    # Setup logging
    setup_logging()
    logger = logging.getLogger("Union_Test")
    
    try:
        logger.info("Starting Union_Test Spark Application")
        
        # Load configuration
        config = load_config(args.config)
        
        # Create Spark session
        spark = create_spark_session("Union_Test", config)
