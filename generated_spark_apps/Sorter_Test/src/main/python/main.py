"""
Main Application for Sorter_Test
...
def setup_logging(log_level: str = "INFO"):
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('logs/sorter_test.log')
        ]
    )
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Sorter_Test Spark Application')
    ...
    # Setup logging
    setup_logging()
    logger = logging.getLogger("Sorter_Test")
    
    try:
        logger.info("Starting Sorter_Test Spark Application")
        
        # Load configuration
        config = load_config(args.config)
        
        # Create Spark session
        spark = create_spark_session("Sorter_Test", config)
